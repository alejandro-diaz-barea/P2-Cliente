...
// *** Traversing de padres a hijos ***

const navegacion = document.querySelector("nav");
console.log(navegacion);

// Si expandimos e resultado en la consola, vemos que nos muestra las etiquetas a.
...
// La diferencia es que childNodes considera los espacios en blanco (saltos de linea) como elementos.
...
// Acceder al titulo
console.log(card.children[1].children); // Vemos que el título es la posicion 1
...
card.children[1].children[1].textContent =
  "Nuevo título desde traversing de DOM";
...
// console.log(card.parentNode) -> Pasa como con childNodes, tiene en cuenta los espacios en blanco, mejor usar parentElement.
...
// Tambien podemos acceder al elemento directamente, como vimos antes...
