...
// console.log(document) -- Vemos que nos muestra todos los elementos, por eso siempre vamos a usar document. para seleccionar cualquier elemento.
elemento = document; // Seleccionamos el documento
elemento = document.all; // Todas las etiquetas que tenemos en el proyecto.
...
elemento = document.forms; // Seleccionamos la colección de formularios del documento - Devuelve una HTML collection, muy parecido a un array.
